...
class DDPM(pl.LightningModule):
    ...
    def p_mean_variance(self, x, t, clip_denoised: bool,cond=None):
        model_out = self.model(x, t, c_crossattn=[cond])
        if self.parameterization == "eps":
    ...
    def sample(self, batch_size=16, cond=None, return_intermediates=False):
        ...
        return self.p_sample_loop((batch_size, channels, image_size, image_size), cond=cond,
    ...
    def p_losses(self, x_start, cond, t,  noise=None):
        ...
        model_out = self.model(x_noisy, t, c_crossattn=[cond])
    ...
    def log_images(self, batch, N=8, n_row=2, sample=True, return_keys=None, **kwargs):
        ...
        if sample:
            ...
            with self.ema_scope("Plotting"):
                samples, denoise_row = self.sample(batch_size=N,cond=c, return_intermediates=True)
